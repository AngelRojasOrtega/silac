 ...
 * @author siman
 */
@ManagedBean(name="informeExamenesSeccionBean")
@ViewScoped
public class InformeExamenesSeccionBean implements Serializable{
    ...
    /** Creates a new instance of InformeExamenesSeccionBean */
    public InformeExamenesSeccionBean() {
        this.init();
    }
    ...
    public void imprimir() {
        ...
        String fileName = "informeExamenesSeccion";
