...
public class InformesBean implements Serializable {
    ...
    public void onSelectInforme (){
        ...
        if(this.selectedInforme !=null){ 
             ...
             else if("informeMenActividadesLaboratorio".equals(selectedInforme)){
                 String params="&tipo="+ this.selectedTipo + "&anio="+this.anio + "&mes="+ (this.selectedMes+1);
               this.url=this.url + fileName + params;  
             }
