 ...
 * @author siman
 */
@ManagedBean(name="informeSeccionAsignadaEmpleadoBean") 
@ViewScoped
public class InformeSeccionAsignadaEmpleado implements Serializable{
    ...
    /** Creates a new instance of InformeSeccionAsignadaEmpleado */
    public InformeSeccionAsignadaEmpleado() {
         this.init();
    }
    ...
    public void imprimir() {
        ...
        String fileName = "informeSeccionesEmpleado";
        String tipo = this.selectedTipo;       
       
        
        String params = "&tipo=" + tipo + "&empleado=" + selectedEmpleado + "&mes=" + (selectedMes+1) + "&anio=" + selectedAnio;
