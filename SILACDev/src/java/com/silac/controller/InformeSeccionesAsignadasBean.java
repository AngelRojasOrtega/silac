 ...
 * @author siman
 */
@ManagedBean(name="informeSeccionesAsignadasBean")
@ViewScoped
public class InformeSeccionesAsignadasBean implements Serializable {
    ...
    /** Creates a new instance of InformeSeccionesAsignadasBean */
    public InformeSeccionesAsignadasBean() {
        this.init();
    }
    ...
    public void imprimir() {
        ...
        String fileName = "informeSeccionesAsignadas";
